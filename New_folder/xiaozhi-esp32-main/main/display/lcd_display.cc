...
void LcdDisplay::InitializeLcdThemes() {
    ...
    dark_theme->set_low_battery_color(lv_color_hex(0x000000));          //rgb(0, 0, 0) — make low-battery bar invisible on dark theme
...
void LcdDisplay::SetupUI() {
    ...
    // Position popup below the screen so it won't overlap the bottom status text
    lv_obj_set_y(low_battery_popup_, LV_VER_RES);
