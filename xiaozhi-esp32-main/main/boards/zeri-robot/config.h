...
#define FRONT_RIGHT_LEG_PIN    GPIO_NUM_39
#define BACK_RIGHT_LEG_PIN GPIO_NUM_38
#define FRONT_LEFT_LEG_PIN GPIO_NUM_17
#define BACK_LEFT_LEG_PIN GPIO_NUM_18 
#define TAIL_PIN GPIO_NUM_8
